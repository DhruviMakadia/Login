  ...
  ((t = (function () {
    ...
    return function (a, n) {
      ...
      if (
        ...
        for (var o = 0; o < i.options.calendarEvents.length; o++)
          i.options.calendarEvents[o].id ||
            console.log(
              '%c Event named: "' +
                i.options.calendarEvents[o].name +
                "\" doesn't have a unique ID ",
              "color:white;font-weight:bold;background-color:#e21d1d;"
            ),
            i.isValidDate(i.options.calendarEvents[o].date) &&
              (i.options.calendarEvents[o].date = i.formatDate(
                i.options.calendarEvents[o].date,
                i.options.format
              ));
      (i.startingDay = null),
        (i.monthLength = null),
        (i.$current = {
          ...
          year:
            isNaN(this.year) || null == this.year
              ...
              : this.year,
          date: i.formatDate(
            i.initials.dates[i.defaults.language].months[
              new Date().getMonth()
            ] +
              " " +
              new Date().getDate() +
    ...
    e(a.$elements.calendarEl).hasClass("calendar-initialized") ||
      ...
      n <= a.$breakpoints.tablet
        ...
        : (a.options.sidebarDisplayDefault ||
            e(a.$elements.calendarEl).addClass("sidebar-hide"),
          a.options.eventDisplayDefault ||
            e(a.$elements.calendarEl).addClass("event-hide")),
    ...
    (t.prototype.destroy = function () {
      ...
      t.destroyEventListener(),
        t.$elements.calendarEl &&
          (t.$elements.calendarEl.removeClass("calendar-initialized"),
    ...
    (t.prototype.parseFormat = function (e) {
      ...
      return (
        (t && t.length && a && 0 !== a.length) ||
          console.log(
            "%c Invalid date format ",
            "color:white;font-weight:bold;background-color:#e21d1d;"
          ),
        { separators: t, parts: a }
      );
    }),
    (t.prototype.formatDate = function (t, a, n) {
      ...
      (r.dd = (r.d < 10 ? "0" : "") + r.d),
        ...
        (t = []);
      for (
        var s = e.extend([], a.separators), l = 0, d = a.parts.length;
        l <= d;
        l++
      )
        s.length && t.push(s.shift()), t.push(r[a.parts[l]]);
      return t.join("");
    }),
    ...
    (t.prototype.isBetweenDates = function (e, t) {
      ...
      return (
        t instanceof Array
          ? ((a = new Date(t[0])), (n = new Date(t[1])))
          : ((a = new Date(t)), (n = new Date(t))),
    ...
    (t.prototype.setTheme = function (t) {
      ...
      (a.options.theme = t.toLowerCase().split(" ").join("-")),
        ...
        "default" !== a.options.theme &&
          e(a.$elements.calendarEl).addClass(a.options.theme);
    }),
    ...
    (t.prototype.initEventListener = function () {
      ...
      e(window)
        ...
        t.options.sidebarToggler &&
          t.$elements.sidebarToggler
            .off("click.evocalendar")
            .on("click.evocalendar", t.toggleSidebar),
        t.options.eventListToggler &&
          t.$elements.eventListToggler
            .off("click.evocalendar")
            .on("click.evocalendar", t.toggleEventList),
        t.$elements.sidebarEl
          .find("[data-month-val]")
          .off("click.evocalendar")
          .on("click.evocalendar", t.selectMonth),
        t.$elements.sidebarEl
          .find("[data-year-val]")
          .off("click.evocalendar")
          .on("click.evocalendar", t.selectYear),
        t.$elements.eventEl
          .find("[data-event-index]")
          .off("click.evocalendar")
          .on("click.evocalendar", t.selectEvent);
    }),
    (t.prototype.destroyEventListener = function () {
      ...
      e(window).off("resize.evocalendar.evo-" + t.instanceUid),
        e(window).off("click.evocalendar.evo-" + t.instanceUid),
        t.options.sidebarToggler &&
          t.$elements.sidebarToggler.off("click.evocalendar"),
        t.options.eventListToggler &&
          t.$elements.eventListToggler.off("click.evocalendar"),
        t.$elements.innerEl
          .find(".calendar-day")
          .children()
          .off("click.evocalendar"),
      ...
      if ((t.calculateDays(), !t.$elements.calendarEl.html())) {
        ...
        for (var n = 0; n < t.$label.months.length; n++)
          a +=
            ...
            n +
            '">' +
            t.initials.dates[t.options.language].months[n] +
            "</li>";
        (a += "</ul>"),
          (a += "</div></div>"),
          (a +=
        ...
        for (n = 0; n < t.$label.days.length; n++) {
          ...
          (t.$label.days[n] !== t.initials.weekends.sat &&
            t.$label.days[n] !== t.initials.weekends.sun) ||
            (i += " --weekend"),
        ...
        (a += "</tr></table></div>"),
          ...
          t.$elements.sidebarEl ||
            (t.$elements.sidebarEl = e(t.$elements.calendarEl).find(
              ".calendar-sidebar"
            )),
          t.$elements.innerEl ||
            (t.$elements.innerEl = e(t.$elements.calendarEl).find(
              ".calendar-inner"
            )),
          t.$elements.eventEl ||
            (t.$elements.eventEl = e(t.$elements.calendarEl).find(
              ".calendar-events"
            )),
          t.options.sidebarToggler &&
            (e(t.$elements.sidebarEl).append(
              '<span id="sidebarToggler" role="button" aria-pressed title="' +
                t.initials.dates[t.options.language].closeSidebarText +
                '"><button class="icon-button"><span class="bars"></span></button></span>'
            ),
            t.$elements.sidebarToggler ||
              (t.$elements.sidebarToggler = e(t.$elements.sidebarEl).find(
                "span#sidebarToggler"
              ))),
          t.options.eventListToggler &&
            ...
            t.$elements.eventListToggler ||
              (t.$elements.eventListToggler = e(t.$elements.calendarEl).find(
    ...
    (t.prototype.buildEventList = function () {
      ...
      if ((i.children().length > 0 && i.empty(), t.options.calendarEvents))
        for (var o = 0; o < t.options.calendarEvents.length; o++)
          if (
            t.isBetweenDates(t.$active.date, t.options.calendarEvents[o].date)
          )
            ...
            new Date(t.$active.date).getMonth() +
              ...
              new Date(t.options.calendarEvents[o].date).getMonth() +
                1 +
                " " +
                new Date(t.options.calendarEvents[o].date).getDate() &&
              r(t.options.calendarEvents[o]);
          }
      function r(e) {
    ...
    (t.prototype.buildSidebarMonths = function () {
      ...
      e.$elements.sidebarEl
        ...
        e.$elements.sidebarEl
          .find('.calendar-months > [data-month-val="' + e.$active.month + '"]')
    ...
    (t.prototype.buildCalendar = function () {
      ...
      a.calculateDays(),
        (t = a.formatDate(
          new Date(a.$label.months[a.$active.month] + " 1 " + a.$active.year),
          a.options.titleFormat,
          a.options.language
        )),
      ...
      for (var n = 1, i = 0; i < 9; i++) {
        for (var o = 0; o < a.$label.days.length; o++) {
          if (n <= a.monthLength && (i > 0 || o >= a.startingDay)) {
            var r = "calendar-day";
            (a.$label.days[o] !== a.initials.weekends.sat &&
              a.$label.days[o] !== a.initials.weekends.sun) ||
              (r += " --weekend"),
              (e += '<td class="' + r + '">'),
              (e +=
                '<div class="day" role="button" data-date-val="' +
                a.formatDate(
                  a.$label.months[a.$active.month] +
                    " " +
                    n +
                    " " +
                    a.$active.year,
      ...
      (e += "</tr>"),
        ...
        a.options.todayHighlight &&
          a.$elements.innerEl
            .find("[data-date-val='" + a.$current.date + "']")
            .addClass("calendar-today"),
        a.$elements.innerEl
          .find(".calendar-day")
          .children()
          .off("click.evocalendar")
          .on("click.evocalendar", a.selectDate);
      var s = a.$elements.innerEl.find(
        "[data-date-val='" + a.$active.date + "']"
      );
      s &&
        (a.$elements.innerEl.children().removeClass("calendar-active"),
      ...
      if (i instanceof Array) {
        if (e.everyYear)
          for (var r = 0; r < i.length; r++)
            i[r] = n.formatDate(
              new Date(i[r]).setFullYear(n.$active.year),
              n.options.format
            );
        ...
        e.everyYear &&
          (i = n.formatDate(
            new Date(i).setFullYear(n.$active.year),
            n.options.format
          )),
          d(i);
      function d(i) {
        0 ===
          (a = n.$elements.innerEl.find('[data-date-val="' + i + '"]')).find(
            "span.event-indicator"
          ).length && a.append('<span class="event-indicator"></span>'),
          0 ===
            a.find("span.event-indicator > .type-bullet > .type-" + o).length &&
            ((t = '<div class="type-bullet"><div '),
            (t += 'class="type-' + e.type + '"'),
            e.color && (t += 'style="background-color:' + e.color + '"'),
            (t += "></div></div>"),
    ...
    (t.prototype.selectEvent = function (t) {
      ...
      r.date instanceof Array && (r.dates_range = a.getBetweenDates(r.date)),
        e(a.$elements.calendarEl).trigger("selectEvent", [
          a.options.calendarEvents[o],
        ]);
    }),
    (t.prototype.selectYear = function (t) {
      ...
      "string" == typeof t || "number" == typeof t
        ? 4 === parseInt(t).toString().length && (n = parseInt(t))
        : ((a = e(t.target).closest("[data-year-val]")),
          (n = e(a).data("yearVal"))),
        "prev" == n
          ? --i.$active.year
          : "next" == n
          ? ++i.$active.year
          : "number" == typeof n && (i.$active.year = n),
    ...
    (t.prototype.selectMonth = function (t) {
      ...
      "string" == typeof t || "number" == typeof t
        ? t >= 0 &&
          t <= a.$label.months.length &&
          (a.$active.month = t.toString())
        : (a.$active.month = e(t.currentTarget).data("monthVal")),
        n <= a.$breakpoints.tablet && i && a.toggleSidebar(!1),
        a.buildSidebarMonths(),
        a.buildCalendar(),
        e(a.$elements.calendarEl).trigger("selectMonth", [
          a.initials.dates[a.options.language].months[a.$active.month],
          a.$active.month,
        ]);
    }),
    ...
    (t.prototype.toggleSidebar = function (t) {
      var a,
        ...
        o = this;
      (i = e(window).width()),
        void 0 === t || t.originalEvent
          ? e(o.$elements.calendarEl).toggleClass("sidebar-hide")
          : t
          ? e(o.$elements.calendarEl).removeClass("sidebar-hide")
          : e(o.$elements.calendarEl).addClass("sidebar-hide"),
        i <= o.$breakpoints.tablet &&
          i > o.$breakpoints.mobile &&
    ...
    (t.prototype.toggleEventList = function (t) {
      ...
      (i = e(window).width()),
        void 0 === t || t.originalEvent
          ? e(o.$elements.calendarEl).toggleClass("event-hide")
          : t
          ? e(o.$elements.calendarEl).removeClass("event-hide")
          : e(o.$elements.calendarEl).addClass("event-hide"),
        i <= o.$breakpoints.tablet &&
          i > o.$breakpoints.mobile &&
          ((n = !o.$elements.calendarEl.hasClass("event-hide")),
          (a = !o.$elements.calendarEl.hasClass("sidebar-hide")),
    ...
    (t.prototype.addCalendarEvent = function (e) {
      ...
      function a(e) {
        if (
          (e.id ||
            console.log(
              '%c Event named: "' + e.name + "\" doesn't have a unique ID ",
              "color:white;font-weight:bold;background-color:#e21d1d;"
            ),
          ...
          for (var a = 0; a < e.date.length; a++)
            n(e.date[a]) &&
              (e.date[a] = t.formatDate(new Date(e.date[a]), t.options.format));
        else
          n(e.date) &&
            (e.date = t.formatDate(new Date(e.date), t.options.format));
        function n(a) {
          return (
            !!t.isValidDate(a) ||
            (console.log(
              '%c Event named: "' + e.name + '" has invalid date ',
              "color:white;font-weight:bold;background-color:#e21d1d;"
            ),
            !1)
          );
      ...
      for (e = 0; e < r; e++)
        if (
          ("object" == typeof i || void 0 === i
            ? (n[e].evoCalendar = new t(n[e], i))
            : (a = n[e].evoCalendar[i].apply(n[e].evoCalendar, o)),
          void 0 !== a)
        )
          return a;
      return n;
